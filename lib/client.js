window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    @media (max-width: 768px) {
      ...
      [data-dsh-toggle-cluster] { position: fixed !important; top: max(8px, env(safe-area-inset-top)) !important; left: 8px !important; right: auto !important; z-index: 1300 !important; width: 44px !important; height: 44px !important; }
      [data-dsh-toggle-cluster] > button { width: 44px !important; height: 44px !important; min-width: 44px !important; min-height: 44px !important; }
